...
public class Launch_Browser {
	...
	public static void Screenshot(String Screenshot_name_01) throws Throwable {
		...
		File target1 = new File(projectpath + "\\Screenshots_02\\" + Screenshot_name_01 + ".png");

		FileHandler.copy(source1, target1);

	}
	
	public static void DropdownSc(String Screenshot_Name_01) throws Throwable {
		TakesScreenshot sc_02=(TakesScreenshot) driver;
		
		File source2=sc_02.getScreenshotAs(OutputType.FILE);
		
		File target1= new File("./dropdownSc/"+Screenshot_Name_01+".png");
	...
	public static void ActionsClass(WebElement actionname) {
		Actions act= new Actions(driver);
		
		act.moveToElement(actionname).click().build().perform();;
	}
